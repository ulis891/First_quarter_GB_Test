...
// Метод для формирования и заполнения нового массива с колличеством символов меньше или раным 3
string[] FillShortStringsArray (int shortStringsNumber, string[] array)
{
    ...
    // Возвращаем массив сформированный из строк с колличеством символов меньше или раным 3
...
PrintArray(FillShortStringsArray(CountShortStrings(stringsArray), stringsArray));